...
def collect_geo (input_filename, output_folder, config, n_workers = mp.cpu_count(), proxies = []):
    geolist = ["Coahuila Ocampo", "Coahuila AcuÃ±a", "Coahuila Piedras", "Coahuila Guerrero", "Coahuila Hidalgo", "Nuevo LeÃ³n AnÃ¡huac", "Tamaulipas Nuevo Laredo", "Tamaulipas Guerrero", "Tamaulipas Mier", "Tamaulipas Miguel AlemÃ¡n", "Tamaulipas Gustavo DÃ­az Ordaz", "Tamaulipas Reynosa", "Tamaulipas RÃ­o Bravo", "Tamaulipas Matamoros", "Texas El Paso", "Texas Hudspeth", "Texas Jeff Davis", "Texas Presidio County", "Texas Brewster County", "Texas Terrell County", "Texas Val Verde County", "Texas Kinney County", "Texas Maverick County", "Texas Webb County", "Texas Zapata County", "Texas Starr County", "Texas Hidalgo County", "Texas Cameron County", "California San Diego", "California Imperial", "Chihuahua Janos", "Chihuahua AscensiÃ³n", "Chihuahua JuÃ¡rez", "Chihuahua Guadalupe", "Chihuahua PrÃ¡xedis G. Guerrero", "Chihuahua Guadalupe", "Chihuahua Ojinaga", "Chihuahua Manuel Benavides", "Arizona Yuma", "Arizona Pima", "Arizona Santa Cruz", "Arizona Cochise", "New Mexico Hidalgo", "New Mexico Luna", "New Mexico DoÃ±a Ana", "Bajia California Tijuana", "Bajia California Tecate", "Bajia California Mxicali", "Sonora San Luis RÃ­o Colorado", "Sonora Puerto PeÃ±asco", "Sonora Plutarco ElÃ­as Calles", "Sonora Caborca", "Sonora Altar", "Sonora SÃ¡ric", "Sonora Nogales", "Sonora Santa Cruz", "Sonora Cananea", "Sonora Naco", "Sonora Agua Prieta"]
    # if (input_filename.endswith('.csv')):
